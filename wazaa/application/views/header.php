   ...
   <div class="container alert">
      <div class="row d-none d-lg-flex align-items-center">
         ...
         <div class="col-sm-12 col-lg-3">
            <a href="<?= site_url('produits/tableau/');?>" title="JardiTou"><img class="img-fluid" src="<?php echo base_url("assets/images/wazaa_logo.png");?>" alt="Logo Wazaa immo"></a>
         </div>
      ...
      <div class="d-sm-none d-lg-block col-lg-4"></div>
         ...
         <div class="col-sm-12 col-lg-5">
            <h1 class="text-center">Numéro 1 sur le marché Amiénois</h1>
         </div>
         ...
         <nav class="navbar navbar-expand-lg navbar-light alert-primary">
            ...
            <div class="collapse navbar-collapse col-lg-6" id="navbarSupportedContent">
               <ul class="navbar-nav mr-auto col-lg-6">
                  ...
                  <li class="nav-item">
                     <a class="nav-link" href="<?=site_url("annonce/liste")?>">Liste</a>
                  </li>
                  <li class="nav-item">
                     <a class="nav-link" href="<?=site_url("utilisateur/formulaire")?>">Contact</a>
                  </li>
                  <li class="nav-item">
                     <a class="nav-link" href="<?=site_url("utilisateur/accueil")?>">A propos</a>
                  </li>
            ...
            <?php
            if (is_null($this->session->role))
            {?>
               <button type="button" class="btn btn-outline-success my-2 my-sm-0" data-toggle="modal" data-target="#modal_connexion"><strong> Connexion </strong></button>
            <?php } 
            else
            { ?>
               <a href="<?= site_url('Utilisateur/disconnect') ;?>">
               <button type="button" class="btn btn-outline-danger my-2 my-sm-0" ><strong> Deconnexion </strong></button>
               </a>
            <?php } ?>
